...
(function (args) {
  var port = hollerConfig&&hollerConfig.port ? hollerConfig.port : "1337",
      host = hollerConfig&&hollerConfig.host ? hollerConfig.host : "http://127.0.0.1";
  ...
  loadScript(host+":"+port+"/faye/client.js", function(){
    ...
    var subscription = client.subscribe('/telepathy',function(obj) {
